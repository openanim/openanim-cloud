    ...
    <section id="why" aria-labelledby="why-title">
      ...
      <div className="section">
        ...
        <div className="why-grid">
          ...
          >
            <span className="code-comment"># install: pip install openanim</span>{'\n'}
            {'\n'}
            <span className="code-key">from</span> openanim <span className="code-key">import</span> Orchestrator{'\n'}
            {'\n'}
            orc = Orchestrator(){'\n'}
            {'\n'}
            result = <span className="code-key">await</span> orc.generate({'\n'}
            {'    '}<span className="code-val">prompt</span>=<span className="code-comment">&quot;Explain Fourier transforms&quot;</span>,{'\n'}
            {'    '}<span className="code-val">provider</span>=<span className="code-comment">&quot;manim&quot;</span>,{'\n'}
            ){'\n'}
            {'\n'}
            <span className="code-comment"># same input → same output, always</span>{'\n'}
          ...
          <div className="why-points" role="list">
            {WHY_POINTS.map((p) => (
              <div className="why-point" key={p.title} role="listitem">
                <div className="why-point-icon" aria-hidden="true">{p.icon}</div>
                <div>
